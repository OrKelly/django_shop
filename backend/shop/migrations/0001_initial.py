# Generated by Django 4.2.9 on 2024-01-26 16:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default=999.99, max_digits=7, verbose_name='Цена')),
                ('image', models.ImageField(default='images/products/default.jpg', upload_to='images/products/%Y/%m/%d', verbose_name='Изображение')),
                ('available', models.IntegerField(default=10, null=True, verbose_name='Наличие')),
