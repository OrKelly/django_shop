...
SECRET_KEY = 'django-insecure-he9=@ecfip2h0njq#x92zfi&(vywf1eg3303k3-y!os_vj1kop'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'ShopDjango' /'templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
EMAIL_FROM_ADDRESS = 'kern20007@gmail.com'  # mandatory
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'kern20007@gmail.com'
